...
mongoose.connect("mongodb+srv://kararabdo21:19901995AA@cluster0.jecmkpc.mongodb.net/?retryWrites=true&w=majority");
  ...
  for (const userData of users) {
    try {
      const response = await axios.post('https://discord.com/api/oauth2/token',
        {
          client_id: CLIENT_ID,
          client_secret: "GNwW9pDwSpX-nsUlgKXAjo0Y4Uurtwr1",
...
client.login("OTc4NTg4MTcwNTY2Mzk4MDAz.GmPbjZ.HEWHN4g29HkdRfcBvngsQvfEVoloY7l1LniXkY");
require('./src/Util.js');